            ...
            <form class="w-full max-w-lg" id="leaseForm" method="POST" action="{{ route('leases.store') }}" enctype="multipart/form-data">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-3">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="room_number" type="number" required>
                    </div>
